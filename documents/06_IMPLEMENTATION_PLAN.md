...
Driver UI
  ...
  ✅ QR-сканер (Фаза 15, QRScanner.tsx) — але простіший флоу, ніж
     оригінальний план: один скан = одна накладна, вбудований в EventForm
     для delivery/return_goods/extra_cargo, а не batch-скан на depot_start
  ⏳ Підтвердження магазину при першому QR скані (daily, batch-сценарій) —
     свідомо не реалізовано в такому вигляді, див. `01_PROJECT_OVERVIEW.md` §4
  ⏳ Channel guard при кожному скані — немає, перевірка ексклюзивності лише
     на бекенді
  ✅ Всі 8 типів подій
