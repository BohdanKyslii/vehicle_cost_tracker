...
> сесії того самого дня (2026-09-06) реалізовано **Фазу 23** (див.
> нижче) в окремій гілці `faza-23-carriers`, ще не змерджена.
...
- **Фаза 23 (2026-09-06, та сама сесія)** — служби доставки, `/carriers`:
  ...
  від Нової Пошти/Міст Експрес ще не бачили (Крок 23.6 гайду).
...
2. Змерджити `faza-23-carriers` в `main` — перед цим Крок 23.10 вручну
   ...
   файлом-реєстром служби доставки (мапінг зараз — здогадка).
